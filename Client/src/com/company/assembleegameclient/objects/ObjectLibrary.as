...
public class ObjectLibrary {
    ...
    public static function parseDungeonXML(_arg_1:String, _arg_2:XML):void {
        var _local3:int = (_arg_1.indexOf("_") + 1);
        var _local4:int = _arg_1.indexOf("CXML");
        currentDungeon = _arg_1.substr(_local3, (_local4 - _local3));
        dungeonsXMLLibrary_[currentDungeon] = new Dictionary(true);
        parseFromXML(_arg_2, parseDungeonCallback);
    }

    private static function parseDungeonCallback(_arg_1:int, _arg_2:XML) : void {
    ...
    public static function parseFromXML(_arg_1:XML, _arg_2:Function = null):void {
        ...
        var _local7:Boolean;
        var _local8:int;
        for each (_local3 in _arg_1.Object) {
            ...
            _local_6 = int(_local3.@type);
            if (((_local3.hasOwnProperty("PetBehavior")) || (_local3.hasOwnProperty("PetAbility")))) {
                petXMLDataLibrary_[_local_6] = _local3;
            }
            else {
                propsLibrary_[_local_6] = new ObjectProperties(_local3);
                xmlLibrary_[_local_6] = _local3;
                idToType_[_local4] = _local_6;
                typeToDisplayId_[_local_6] = _local5;
                if (_arg_2 != null) {
                    (_arg_2(_local_6, _local3));
                }
                if (String(_local3.Class) == "Player") {
                    playerClassAbbr_[_local_6] = String(_local3.@id).substr(0, 2);
                    _local7 = false;
                    _local8 = 0;
                    while (_local8 < playerChars_.length) {
                        if (int(playerChars_[_local8].@type) == _local_6) {
                ...
                typeToTextureData_[_local_6] = textureDataFactory.create(_local3);
                if (_local3.hasOwnProperty("Top")) {
                    typeToTopTextureData_[_local_6] = textureDataFactory.create(XML(_local3.Top));
                }
                if (_local3.hasOwnProperty("Animation")) {
                    typeToAnimationsData_[_local_6] = new AnimationsData(_local3);
                }
            }
        }
    }
    ...
    public static function getRedrawnTextureFromType(_arg_1:int, _arg_2:int, _arg_3:Boolean, _arg_4:Boolean = true, _arg_5:Number = 5):BitmapData {
        ...
        if(Parameters.itemTypes16.indexOf(_arg_1) != -1 || _local_6.height == 15)
        {
            _arg_2 = _arg_2 * 0.5333;
        }
        if(Parameters.itemTypes16.indexOf(_arg_1) != -1 || _local_6.height == 14)
        {
            _arg_2 = _arg_2 * 0.5714;
        }
        if(Parameters.itemTypes16.indexOf(_arg_1) != -1 || _local_6.height == 13)
        {
            _arg_2 = _arg_2 * 0.6153;
        }
        //
        if(Parameters.itemTypes16.indexOf(_arg_1) != -1 || _local_6.height == 12)
        {
            _arg_2 = _arg_2 * 0.75;
        }
        //for all type of stuffs
        if(Parameters.itemTypes16.indexOf(_arg_1) != -1 || _local_6.height == 11)
        {
            _arg_2 = _arg_2 * 0.7272;
        }
        if(Parameters.itemTypes16.indexOf(_arg_1) != -1 || _local_6.height == 10)
        {
            _arg_2 = _arg_2 * 0.80;
        }
        if(Parameters.itemTypes16.indexOf(_arg_1) != -1 || _local_6.height == 9)
        {
            _arg_2 = _arg_2 * 0.8888;
        }
    ...
    public static function isUsableByPlayer(_arg_1:int, _arg_2:Player):Boolean {
        ...
        var _local5:int;
        while (_local5 < _arg_2.slotTypes_.length) {
            if (_arg_2.slotTypes_[_local5] == _local4) {
                return (true);
            }
            _local5++;
    ...
    public static function usableBy(_arg_1:int):Vector.<String> {
        ...
        for each (_local5 in playerChars_) {
            _local_6 = ConversionUtil.toIntVector(_local5.SlotTypes);
            _local7 = 0;
            while (_local7 < _local_6.length) {
                if (_local_6[_local7] == _local3) {
    ...
    public static function playerMeetsRequirements(_arg_1:int, _arg_2:Player):Boolean {
        ...
        for each (_local4 in _local3.EquipRequirement) {
            if (!playerMeetsRequirement(_local4, _arg_2)) {
                return (false);
            }
        }
        return (true);
        ...
        if (_arg_1.toString() == "Stat") {
            ...
            switch (int(_arg_1.@stat)) {
                ...
                case StatData.WISDOM_STAT:
                    return ((_arg_2.wisdom_ >= _local3));
                case StatData.DEXTERITY_STAT:
                    return ((_arg_2.dexterity_ >= _local3));
                case StatData.LUCK_STAT:
                    return ((_arg_2.luck_ >= _local3));
                case StatData.MIGHT_STAT:
                    return ((_arg_2.might_ >= _local3));
                case StatData.RESTORATION_STAT:
                    return ((_arg_2.restoration_ >= _local3));
                case StatData.PROTECTION_STAT:
                    return ((_arg_2.protection_ >= _local3));
            }
        }
        return (false);
    }
